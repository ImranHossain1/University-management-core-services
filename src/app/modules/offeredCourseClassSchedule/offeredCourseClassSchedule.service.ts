...
import { IOfferedCourseClassScheduleFilterRequest } from '../offeredCourse/offeredCourseClassSchedule.interface';
import {
...
const insertIntoDB = async (
  ...
  await OfferedCourseClassScheduleUtils.checkRookAvailable(data);
