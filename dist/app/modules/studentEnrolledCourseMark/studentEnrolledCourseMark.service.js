...
const createStudentEnrolledCourseDefaultMark = (prismaClient, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isExitMidtermData =
      yield prismaClient.studentEnrolledCourseMark.findFirst({
        where: {
...
const updateStudentMarks = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { studentId, academicSemesterId, courseId, examType, marks } =
      payload;
    const studentEnrolledCourseMarks =
      yield prisma_1.default.studentEnrolledCourseMark.findFirst({
        where: {
          student: {
            id: studentId,
          },
    ...
    const result =
      studentEnrolledCousreMark_utils_1.StudentEnrolledCourseMarkUtils.getGradeFromMarks(
        marks
      );
    const updateStudentMarks =
      yield prisma_1.default.studentEnrolledCourseMark.update({
        where: {
...
const updateFinalMarks = payload =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { studentId, academicSemesterId, courseId } = payload;
    const studentEnrolledCourse =
      yield prisma_1.default.studentEnrolledCourse.findFirst({
        where: {
          student: {
            id: studentId,
          },
    ...
    const studentEnrolledCourseMarks =
      yield prisma_1.default.studentEnrolledCourseMark.findMany({
        where: {
          student: {
            id: studentId,
          },
    ...
    const midTermMarks =
      ((_a = studentEnrolledCourseMarks.find(
        item => item.examType === client_1.ExamType.MIDTERM
      )) === null || _a === void 0
        ? void 0
        : _a.marks) || 0;
    const finalTermMarks =
      ((_b = studentEnrolledCourseMarks.find(
        item => item.examType === client_1.ExamType.FINAL
      )) === null || _b === void 0
        ? void 0
        : _b.marks) || 0;
    ...
    const academicResult =
      yield studentEnrolledCousreMark_utils_1.StudentEnrolledCourseMarkUtils.calcCGPAandGrade(
        grades
      );
    const studentAcademicInfo =
      yield prisma_1.default.studentAcademicInfo.findFirst({
        where: {
          student: {
            id: studentId,
          },
...
const getMyCourseMarks = (filters, options, authUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { limit, page } =
      paginationHelper_1.paginationHelpers.calculatePagination(options);
