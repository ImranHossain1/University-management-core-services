...
const insertIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield offeredCourseSection_service_1.OfferedCourseSectionService.insertIntoDB(
        req.body
      );
...
const getAllFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      offeredCourseSection_constants_1.offeredCourseSectionFilterableFields
    );
    ...
    const result =
      yield offeredCourseSection_service_1.OfferedCourseSectionService.getAllFromDB(
        filters,
        options
      );
    (0, sendResponse_1.default)(res, {
...
const getByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield offeredCourseSection_service_1.OfferedCourseSectionService.getByIdFromDB(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
...
const updateOneInDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield offeredCourseSection_service_1.OfferedCourseSectionService.updateOneInDB(
        id,
        req.body
      );
    (0, sendResponse_1.default)(res, {
...
const deleteByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield offeredCourseSection_service_1.OfferedCourseSectionService.deleteByIdFromDB(
        id
      );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
