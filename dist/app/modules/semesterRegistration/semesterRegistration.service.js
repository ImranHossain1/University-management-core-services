...
const insertIntoDB = data =>
  __awaiter(void 0, void 0, void 0, function* () {
    const isAnySemesterRegUpcomingOrOngoing =
      yield prisma_1.default.semesterRegistration.findFirst({
        where: {
          OR: [
            {
...
const getAllFromDB = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
      andConditions.push({
        OR: semesterRegistration_constants_1.semesterRegistrationSearchableFields.map(
          field => ({
            [field]: {
              contains: searchTerm,
              mode: 'insensitive',
    ...
    if (Object.keys(filterData).length > 0) {
      andConditions.push({
        AND: Object.keys(filterData).map(key => {
          if (
            semesterRegistration_constants_1.semesterRegistrationRelationalFields.includes(
              key
            )
          ) {
            return {
              [semesterRegistration_constants_1
...
const startMyRegistration = authUserId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (semesterRegistrationInfo === null || semesterRegistrationInfo === void 0
        ? void 0
        : semesterRegistrationInfo.status) ===
      client_1.SemesterRegistrationStatus.UPCOMING
    ) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    let studentRegistration =
      yield prisma_1.default.studentSemesterRegistration.findFirst({
        where: {
          student: {
            id:
              studentInfo === null || studentInfo === void 0
                ? void 0
                : studentInfo.id,
          },
          semesterRegistration: {
            id:
              semesterRegistrationInfo === null ||
              semesterRegistrationInfo === void 0
                ? void 0
                : semesterRegistrationInfo.id,
          },
        },
      });
    if (!studentRegistration) {
      studentRegistration =
        yield prisma_1.default.studentSemesterRegistration.create({
          data: {
            student: {
              connect: {
                id:
...
const enrollIntoCourse = (authUserId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return studentSemesterRegistrationCourse_service_1.studentSemesterRegistrationCourseService.enrollIntoCourse(
      authUserId,
      payload
    );
  });
const withdrewFromCourse = (authUserId, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return studentSemesterRegistrationCourse_service_1.studentSemesterRegistrationCourseService.withdrewFromCourse(
      authUserId,
      payload
    );
  });
const confirmMyRegistration = authUserId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const studentSemesterRegistration =
      yield prisma_1.default.studentSemesterRegistration.findFirst({
        where: {
          semesterRegistration: {
            id:
              semesterRegistration === null || semesterRegistration === void 0
                ? void 0
...
const getMyRegistration = authUserId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const semesterRegistration =
      yield prisma_1.default.semesterRegistration.findFirst({
        where: {
...
const startNewSemester = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const semesterRegistration =
      yield prisma_1.default.semesterRegistration.findUnique({
        where: {
          id,
        },
        include: {
    ...
    if (
      semesterRegistration.status !== client_1.SemesterRegistrationStatus.ENDED
    ) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
    ...
    if (semesterRegistration.academicSemester.isCurrent) {
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
        'Semester is already started!'
      );
    }
    yield prisma_1.default.$transaction(prismaTransactionClient =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const studentSemesterRegistrations =
          yield prisma_1.default.studentSemesterRegistration.findMany({
            where: {
              semesterRegistration: {
                id,
              },
        ...
        yield (0,
        utils_1.asyncForEach)(studentSemesterRegistrations, studentSemReg =>
          __awaiter(void 0, void 0, void 0, function* () {
            if (studentSemReg.totalCreditsTaken) {
              const totalSemesterPaymentAmount =
                studentSemReg.totalCreditsTaken * 5000;
              yield studentSemesterPayment_service_1.StudentSemesterPaymentService.createSemesterPayment(
            ...
            const studentSemesterRegistrationCourses =
              yield prismaTransactionClient.studentSemesterRegistrationCourse.findMany(
                {
                  where: {
                    semesterRegistration: {
                      id,
            ...
            yield (0,
            utils_1.asyncForEach)(studentSemesterRegistrationCourses, item =>
              __awaiter(void 0, void 0, void 0, function* () {
                const isExistEnrolledData =
                  yield prismaTransactionClient.studentEnrolledCourse.findFirst(
                    {
                      where: {
                ...
                if (!isExistEnrolledData) {
                  ...
                  const studentEnrolledCourseData =
                    yield prismaTransactionClient.studentEnrolledCourse.create({
                      data: enrolledCourseData,
                    });
                  yield studentEnrolledCourseMark_service_1.StudentEnrolledCourseMarkService.createStudentEnrolledCourseDefaultMark(
                    prismaTransactionClient,
                    {
                      studentId: item.studentId,
...
const getMySemesterRegCouses = authUserId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const studentCompletedCourse =
      yield prisma_1.default.studentEnrolledCourse.findMany({
        where: {
    ...
    const studentCurrentSemesterTakenCourse =
      yield prisma_1.default.studentSemesterRegistrationCourse.findMany({
        where: {
          student: {
            id: student === null || student === void 0 ? void 0 : student.id,
          },
    ...
    const availableCourses =
      semesterRegistration_utils_1.SemesterRegistrationUtils.getAvailableCourses(
        offeredCourse,
